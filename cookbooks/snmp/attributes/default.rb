...
default['snmp']['syslocationVirtual'] = 'ATT Basic Tier South Central'
default['snmp']['syslocationPhysical'] = 'CompuCom Computer Room'
default['snmp']['syscontact'] = 'CompuCom Portfolio <root@localhost>'
default['snmp']['full_systemview'] = true
...
default['snmp']['include_all_disks'] = true
